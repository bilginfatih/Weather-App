...
extension Color {
    static let primaryColor = Color("Background 1")
    static let secondaryColor = Color("Background 2")
    static let background = LinearGradient(gradient: Gradient(colors: [primaryColor, secondaryColor]), startPoint: .topLeading, endPoint: .bottomTrailing)
    static let bottomSheetBackground = LinearGradient(gradient: Gradient(colors: [primaryColor.opacity(0.26), secondaryColor.opacity(0.26)]), startPoint: .topLeading, endPoint: .bottomTrailing)
